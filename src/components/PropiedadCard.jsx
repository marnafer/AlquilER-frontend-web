...
function PropiedadCard({ propiedad, categoriaNombre }) {
    ...
    return (
        <div className="propiedad-card">
            <div className="propiedad-image">
                ...
                {categoriaNombre && (
                    <span className="propiedad-categoria"><i className="fas fa-tag"></i> {categoriaNombre}</span>
                )}

                <button
                    className="propiedad-fav"
